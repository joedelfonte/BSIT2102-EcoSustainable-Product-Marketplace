...
--
-- Database: `eco-marketbase-database`
--
...
INSERT INTO `status` (`status_id`, `Status`, `role_description`) VALUES
...
INSERT INTO `store` (`store_id`, `EcoStore_id`, `storeName`, `storeDescription`, `owner_id`, `phoneNumber`, `email`, `status_id`, `date_created`, `storeImage`) VALUES
...
--
ALTER TABLE `store`
  MODIFY `store_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
ALTER TABLE `product`
  ADD CONSTRAINT `product_ibfk_2` FOREIGN KEY (`status_id`) REFERENCES `status` (`status_id`),
...
ALTER TABLE `store`
  ...
  ADD CONSTRAINT `store_ibfk_2` FOREIGN KEY (`status_id`) REFERENCES `status` (`status_id`);
