    ...
    try {
        ...
        if ($users) {
            ...
            foreach ($users as $user) {
                ...
                echo "<td><a href='/project/BSIT2102-EcoSustainable-Product-Marketplace/src/users/edit_user.php?id=" . htmlspecialchars($user['id']) . "' class='edit-icon'>Edit</a></td>";
                echo "</tr>";
            }
        ...
        if ($products) {
            ...
            foreach ($products as $product) {
                ...
                echo "<td><a href='/project/BSIT2102-EcoSustainable-Product-Marketplace/src/products/edit_product.php?id=" . htmlspecialchars($product['id']) . "' class='edit-icon'>Edit</a></td>";
                echo "</tr>";
            }
            echo "</tbody></table></div></div>";
        } else {
